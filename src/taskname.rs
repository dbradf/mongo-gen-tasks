...
pub fn name_sub_suite(parent_name: &str, task_index: u64, total_tasks: u64, build_variant: Option<&str>) -> String {
    ...
    format!("{}_{:0fill$}{}", parent_name, task_index, suffix, fill = width)
}
...
mod test {
    ...
    fn test_name_sub_suite() {
        ...
        assert_eq!(name_sub_suite("hello", 42, 314, Some("world")), "hello_042_world");
    }
